...
class DeepCrackDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # Si le label n'a pas pu être chargé
        if lab is None:
            print(f"Warning: Unable to load label image {lab_path}, skipping.")
            return None  # Vous pouvez aussi retourner une valeur par défaut ou ignorer cet élément
