...
def connect():
    ...
    # Créer la table 'images_CC_C'
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS images_CC_C (
    ...
    ''')
    print("La table 'images_CC-C' a été créée avec succès.")

    # Créer la table 'images_CC_S'
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS images_CC_S (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            category TEXT NOT NULL,
            nom_image TEXT NOT NULL,
            image_json TEXT NOT NULL,
    ...
    ''')
    print("La table 'images_CC-S' a été créée avec succès.")

    # Créer la table 'images_CS_C'
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS images_CS_C (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            category TEXT NOT NULL,
            nom_image TEXT NOT NULL,
            image_json TEXT NOT NULL,
    ...
    ''')
    print("La table 'images_CS-C' a été créée avec succès.")

    # Créer la table 'images_CS_S'
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS images_CS_S (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            category TEXT NOT NULL,
            nom_image TEXT NOT NULL,
            image_json TEXT NOT NULL,
    ...
    ''')
    print("La table 'images_CS-S' a été créée avec succès.")

    # Créer la table 'Patchs_300_CS_C'
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS Patchs_300_CS_C (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            category TEXT NOT NULL,
            nom_image TEXT NOT NULL,
            image_json TEXT NOT NULL,
    ...
    ''')
    print("La table 'Patchs_300_CS_C' a été créée avec succès.")
...
def upload_images_grandMare(category, tables):
    conn = connect()
